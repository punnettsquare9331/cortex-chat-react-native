			...
			value: [
				{
					type: 'LINK',
					value: {
						src: { type: 'PLAIN_TEXT', value: 'https://thecortex.cortexflex.org/direct/subaru123?msg=QB42gWcaO6BgqtLTo' },
			...
			value: [
				{
					...
					value: {
						src: {
							type: 'PLAIN_TEXT',
							value: 'https://thecortex.cortexflex.org/group/quoteeee9798789?msg=ZZp6t2dCRX4TqExht'
						},
